...
export const api = {
  ...
  adminWalletPackages: () => request('/admin/wallet-packages'),
  adminCreateWalletPackage: (payload: unknown) => request('/admin/wallet-packages', { method: 'POST', body: JSON.stringify(payload) }),
  adminUpdateWalletPackage: (id: string, payload: unknown) => request(`/admin/wallet-packages/${id}`, { method: 'PATCH', body: JSON.stringify(payload) }),
  adminDeleteWalletPackage: (id: string) => request(`/admin/wallet-packages/${id}`, { method: 'DELETE' }),
